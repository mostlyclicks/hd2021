...
const DentalForms = () => {
  ...
  return (
    ...
    <ul className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4">
      ...
      <a href={'/New-Patient-Registration-full.pdf'}>New Patient Form</a></li>
      ...
      <li className="text-base rounded-lg block border-2 p-4 flex flex-1 sm:flex-col items-center">
      <FaFilePdf className="text-7xl mb-4"/><a href={'/HD-Financial-Policy-full.pdf'}>Financial Policy</a></li>
    </ul>
  )
}
