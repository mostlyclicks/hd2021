...
const Services = () => {
    ...
    return (
        ...
        <SEO title="Services" />
        <Navbar transparent />
            <HeroLevel2 title="Services" image={HeroImage} />
            ...
            <ContentTextPict image={HeroImage} reversed>
                <h3>Restorative Services</h3>
                <p>Many different restorative services are available at Hulse Dental. We aim to provide the best dental care with results that are second to none. Unfortunately we all will probably need restorative (fillings and crowns) oral care at some time during our life. And for that reason it is good to know that Dr. Hulse provides exceptional dental care for you and your family. Whether you choose to whiten your teeth or are in the need of a crown, Hulse Dental is here to provide solutions that work for you!</p>
            </ContentTextPict>
