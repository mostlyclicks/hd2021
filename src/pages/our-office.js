...
import NewPatientForm from "../images/new_patient_form.pdf"
import HealthInfo from "../images/health_info_consent_form.pdf"
    ...
    return (
        ...
        <Navbar transparent />
            ...
            <ContentTextPict image={Img4}>
                ...
                <ul>
                    <li><a href={NewPatientForm}>New Patient Form</a></li>
